...
type
  ...
  TFmain = class(TForm)
    ...
    procedure book_name_labelClick(Sender: TObject);
    procedure book_name_editChange(Sender: TObject);
  private
...
procedure TFmain.ElementShow(Sender: TObject);
Begin
...
procedure TFmain.book_name_labelClick(Sender: TObject);
begin

end;

procedure TFmain.book_name_editChange(Sender: TObject);
begin
